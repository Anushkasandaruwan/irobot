...
import org.homeautomation.irobot.api.dto.SensorRecord;
import org.homeautomation.irobot.api.util.APIUtil;
import org.homeautomation.irobot.api.util.ZipUtil;
import org.homeautomation.irobot.plugin.constants.DeviceTypeConstants;
import org.homeautomation.irobot.api.DeviceTypeService;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    public Response enroll(String deviceName, String deviceId) {

        boolean registerSatus = register(deviceId,deviceName);
        DeviceIdentifier deviceIdentifier = new DeviceIdentifier();
        deviceIdentifier.setId(deviceId);
        deviceIdentifier.setType(DeviceTypeConstants.DEVICE_TYPE);
        try {
            if (APIUtil.getDeviceManagementService().isEnrolled(deviceIdentifier)) {
                String json = "{\"status\":\"Device Already enrolled\"}";
